    ...
    <section className="py-20 px-6 bg-muted/30">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16 space-y-6 animate-fade-in">
          <h2 className="text-4xl lg:text-5xl font-bold">Когда меня зовут?</h2>
          <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">когда больше нельзя терять время</p>
        </div>

        <div className="max-w-4xl mx-auto space-y-6 animate-fade-in" style={{ animationDelay: '200ms' }}>
          <p className="text-lg text-muted-foreground text-center mb-8">Если бизнес:</p>
          ...
          <div className="text-center mt-12 p-8 bg-primary/5 rounded-xl border-2 border-primary/20 animate-fade-in" style={{ animationDelay: '600ms' }}>
            <p className="text-xl font-semibold text-foreground">Когда поле выжжено — я превращаю его в систему роста.</p>
          </div>
        </div>
      </div>
    </section>
